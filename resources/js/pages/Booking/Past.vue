<template>
  <Head title="Past Bookings" />
  
  <MobileAppLayout title="Past Bookings">
    ...
    <div v-if="bookings.length === 0" class="text-center py-12">
      ...
      <h3 class="text-xl font-semibold mb-2 text-tg-text">No past bookings</h3>
      <p class="text-tg-subtitle-text mb-6 px-4">
        You don't have any booking history yet. Your completed appointments will appear here.
      </p>
      ...
      <Card class="bg-tg-section-bg border-tg-section-separator">
        <CardContent class="p-4">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="font-semibold text-tg-text">Booking History</h3>
              <p class="text-sm text-tg-subtitle-text">Your completed appointments</p>
            </div>
