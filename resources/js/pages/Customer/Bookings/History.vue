        ...
        <div class="flex min-h-[--spacing-viewport-h] flex-col">
            ...
            <div class="border-b border-tg-section-separator bg-tg-secondary-bg px-4 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-1 bg-tg-accent/10 px-2 py-1 rounded-full">
                        <History class="h-4 w-4 text-tg-accent" />
            ...
            <div class="flex-1 p-4">
                <div v-if="(bookings?.data?.length || 0) === 0" class="py-12 text-center">
                    <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-tg-section-bg">
                        <History class="h-8 w-8 text-tg-hint" />
                    </div>
                    ...
                    >
                        ...
                        <CardContent class="space-y-3">
                            ...
                            <div class="flex items-center gap-2 text-sm">
                                <DollarSign class="h-4 w-4 text-tg-accent" />
            ...
            <div class="border-t border-tg-section-separator bg-tg-secondary-bg p-4">
                <div class="grid grid-cols-4 gap-2">
                    ...
                    <Link :href="'/bookings/history'" class="flex flex-col items-center gap-1 rounded-lg p-3 bg-tg-accent/10">
                        <History class="h-5 w-5 text-tg-accent" />
                        <span class="text-xs font-medium text-tg-accent">{{ t('app.history') }}</span>
                    </Link>
                </div>
            </div>
        </div>
