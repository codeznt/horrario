        ...
        <div class="min-h-full bg-tg-bg">
            ...
            <div class="relative overflow-hidden bg-gradient-to-r from-tg-accent to-purple-600 px-4 py-6">
                ...
                <div class="relative">
                    ...
                    <h1 class="text-2xl font-bold text-white">{{ t('create_new_service') }}</h1>
                    <p class="mt-1 text-sm text-white/90">{{ t('add_service') }}</p>
                </div>
            </div>
                    ...
                    <Card class="border-tg-section-separator bg-gradient-to-br from-white to-tg-section-bg shadow-sm">
                        <CardHeader class="border-b border-tg-section-separator pb-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle class="text-xl font-bold text-tg-text">{{ t('service_details') }}</CardTitle>
                            ...
                            <form @submit.prevent="submit" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-xs text-tg-hint">{{ t('duration_range') }}</p>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-xs text-tg-hint">{{ t('pricing_display_note') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col gap-3 pt-4 sm:flex-row">
                                    ...
                                    >
                                        ...
                                        <Icon v-else name="Package" class="mr-2 h-4 w-4" />
                                        {{ processing ? t('creating_service') : t('create_service') }}
                                    </Button>
                                    <Button 
                                        type="button" 
                                        variant="outline" 
