  ...
  <div class="min-h-screen bg-background">
    <div class="container mx-auto px-4 py-8">
      <div class="flex items-center justify-between mb-8">
        <div>
          <h1 class="text-3xl font-bold text-foreground">Weekly Schedule</h1>
          <p class="text-muted-foreground mt-2">Manage your working hours</p>
        </div>
      ...
      <div class="grid gap-6">
        <Card v-for="(dayName, dayNumber) in days" :key="dayNumber" class="overflow-hidden">
          ...
          <CardContent>
            <div v-if="!schedules[dayNumber] || schedules[dayNumber].length === 0" 
  ...
  <Dialog :open="showAddDialog" @update:open="showAddDialog = $event">
    <DialogContent class="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription>
          Set your working hours for {{ selectedDay ? days[selectedDay] : '' }}
        </DialogDescription>
      </DialogHeader>
      ...
      <form @submit.prevent="submitSchedule" class="space-y-4">
        ...
        <DialogFooter>
          ...
          <Button type="submit" :disabled="processing">
            ...
            {{ editingSchedule ? 'Update' : 'Add' }} Time Slot
          </Button>
        </DialogFooter>
      </form>
    </DialogContent>
...
import { Plus, Clock, Edit, Trash2, Loader2 } from 'lucide-vue-next'
