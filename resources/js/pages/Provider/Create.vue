...
import { Building2, FileText, MapPin, Phone, Upload, User } from 'lucide-vue-next';
import { ref } from 'vue';
        ...
        <div class="container mx-auto max-w-2xl px-4 py-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {{ t('business_profile_description') }}
                    </CardDescription>
                </CardHeader>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div v-if="imagePreview" class="space-y-2">
                                <div class="relative inline-block">
                                    <img :src="imagePreview" alt="Preview" class="h-24 w-24 rounded-lg border object-cover" />
                                    <Button
                                        type="button"
                                        variant="destructive"
                                        size="sm"
                        ...
                        <div class="flex gap-3 pt-4">
                            <Button type="submit" class="flex-1" :disabled="form.processing">
                                ...
                                {{ form.processing ? t('creating_profile') : t('create_profile') }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
